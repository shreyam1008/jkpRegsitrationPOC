...
* [000-architecture-overview.md](./000-architecture-overview.md) - **(Living Document)** A high-level overview and diagram mapping out the request workflow from the browser to the database.
...
* [005-scope-document.md](./005-scope-document.md) - **(Living Document)** Outlines the target audience, feature boundaries, and phase planning for the registration system.
